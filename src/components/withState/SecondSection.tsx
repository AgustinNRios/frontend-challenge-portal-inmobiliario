        ...
        <div className="relative flex flex-wrap-reverse  lg:flex-row items-center justify-center w-full gap-16 lg:gap-32">
            <div className="relative ">
                <Image
                    ...
                    height={600}
                />
                <div className="absolute top-1/12 left-[6rem] lg:left-[-1rem] xl:left-[-6rem] transition-all duration-300 ease-in-out">
                    <CardWithIcon
                        img="/IconPlay.svg"
                ...
                <div className="absolute bottom-1/12 lg:-bottom-1/12 left-[7rem] lg:left-[7rem] transition-all duration-300 ease-in-out">
                    <CardWithIcon
                        img="/IconHouse.svg"
